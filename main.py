...
OWNER_ID = 6657098333 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [6657098333]

# ✅ Multiple AUTH CHANNELS allowed
AUTH_CHANNELS = [-1002605113558,-1002663510614, -1003383612735]  # Add more channel IDs here
